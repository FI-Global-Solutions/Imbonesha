...
const VERDICT_OPTIONS = [
  { value: "confirmed",    label: "Confirmed Unauthorized" },
  { value: "dismissed",    label: "Dismissed — False Positive" },
  { value: "monitoring",   label: "Under Monitoring" },
  { value: "inaccessible", label: "Site Inaccessible" },
  { value: "data_error",   label: "Data Error — Wrong Location" },
];
...
export default function InspectPage() {
  ...
  const { register, handleSubmit, setValue, watch, formState: { errors, isSubmitting } } = useForm<FormData>({
    ...
    defaultValues: { occupancy_observed: "no" },
  });
      ...
      <div className="px-6 py-5 max-w-2xl w-full space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <Select onValueChange={(v) => setValue("verdict", v as FormData["verdict"])}>
          ...
          {showConstructionFields && (
            <>
              <div className="space-y-1.5">
                ...
                <Select onValueChange={(v) => setValue("construction_stage", v as string)}>
                  <SelectTrigger className="h-10">
          ...
          {/* Visit date */}
          <div className="space-y-1.5">
            <Label htmlFor="visited_at" className="text-sm font-medium">
